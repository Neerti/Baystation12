...
/mob/living/humanoid/bullet_act(var/obj/item/projectile/P, var/def_zone)
...
/mob/living/humanoid/stun_effect_act(var/stun_amount, var/agony_amount, var/def_zone)
...
/mob/living/humanoid/getarmor(var/def_zone, var/type)
	var/armorval = 0
	var/total = 0
...
/mob/living/humanoid/proc/get_siemens_coefficient_organ(var/datum/organ/external/def_zone)
	if (!def_zone)
		return 1.0
...
/mob/living/humanoid/proc/getarmor_organ(var/datum/organ/external/def_zone, var/type)
	if(!type)	return 0
	var/protection = 0
...
/mob/living/humanoid/proc/check_head_coverage()
...
/mob/living/humanoid/proc/check_shields(var/damage = 0, var/attack_text = "the attack")
...
/mob/living/humanoid/emp_act(severity)
...
/mob/living/humanoid/proc/attacked_by(var/obj/item/I, var/mob/living/user, var/def_zone)
	if(!I || !user)	return 0
...
/mob/living/humanoid/hitby(atom/movable/AM as mob|obj,var/speed = THROWFORCE_SPEED_DIVISOR)
	if(istype(AM,/obj/))
		var/obj/O = AM
...
/mob/living/humanoid/embed(var/obj/O, var/def_zone=null)
	if(!def_zone) ..()
...
/mob/living/humanoid/proc/bloody_hands(var/mob/living/source, var/amount = 2)
	if (gloves)
...
/mob/living/humanoid/proc/bloody_body(var/mob/living/source)
	if(wear_suit)
...
/mob/living/humanoid/proc/handle_suit_punctures(var/damtype, var/damage, var/def_zone)
