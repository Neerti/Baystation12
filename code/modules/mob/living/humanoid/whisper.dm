//Lallander was here
/mob/living/humanoid/whisper(message as text)
	var/alt_name = ""
...
/mob/living/humanoid/proc/whisper_say(var/message, var/datum/language/speaking = null, var/alt_name="", var/verb="whispers")
