...
/mob/living/humanoid/biological/proc/pain(var/partname, var/amount, var/force, var/burning = 0)
	if(stat >= 2) return
...
/mob/living/humanoid/biological/proc/custom_pain(var/message, var/flash_strength)
	if(stat >= 1) return
...
/mob/living/humanoid/biological/proc/handle_pain()
	// not when sleeping
